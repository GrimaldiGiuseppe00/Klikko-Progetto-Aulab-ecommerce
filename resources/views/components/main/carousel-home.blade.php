    ...
    <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel" data-bs-interval="3000">
        <div class="carousel-inner" style="max-height:100vh;">
            ...
            <div class="carousel-item active">
                ...
                <img class="img-carousel-descrip mb-2" src="{{ asset('logo/klikko.png') }}" alt="Logo klikko"
                style="max-width:150px">
                
                @auth
                <a href="{{ route('announces.create') }}" class="link-carousel btn">
                    Inserisci articolo
                </a>
                @endauth
            </div>
        ...
        <!-- Controlli -->
        <button class="carousel-control-prev d-inline-block  carousel-control-wrapper " type="button"
